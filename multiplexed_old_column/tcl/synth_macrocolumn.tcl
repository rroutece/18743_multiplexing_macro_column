...
set REP_DIR ./rep
set RTL_DIR ../../src/rtl/
set AREA_RPT $REP_DIR/macrocolumn_area.rpt
set TIME_RPT $REP_DIR/macrocolumn_time.rpt
set POWER_RPT $REP_DIR/macrocolumn_power.rpt

set top_mdl multiplexed_column
define_design_lib WORK -path "./work"

# Small loop to read in several files
#set all_files {../../src/rtl/multiplexed_column.sv}
set all_files {../../src/rtl/adder.sv ../../src/rtl/column.sv ../../src/rtl/cycle_counter.sv ../../src/rtl/edge2pulse.sv ../../src/rtl/fsm_convert.sv ../../src/rtl/fsm_synapse.sv ../../src/rtl/incdec.sv ../../src/rtl/less_equal.sv ../../src/rtl/multiplexed_column.sv ../../src/rtl/neuron_body.sv ../../src/rtl/neuron.sv ../../src/rtl/pac.sv ../../src/rtl/pulse2edge.sv ../../src/rtl/replay_buffer.sv ../../src/rtl/replay_buffer_demux.sv ../../src/rtl/stabilize_func.sv ../../src/rtl/start_count.sv ../../src/rtl/stdp_case_gen.sv ../../src/rtl/stdp.sv ../../src/rtl/wta.sv}
